...
.co-bd__img{position:absolute;inset:-15%;width:130%;height:130%;object-fit:cover;object-position:center top;filter:blur(48px) saturate(1.25);transition:opacity .9s var(--ease-smooth-out)}
...
.co-bd__halo.a{left:-6%;top:-14%;background:radial-gradient(circle at center, hsl(26 82% 55% / .48), hsl(26 82% 55% / .12) 45%, transparent 70%);animation:co-halo-a 15s var(--ease-in-out) infinite}
.co-bd__halo.b{right:-10%;bottom:-16%;background:radial-gradient(circle at center, hsl(220 90% 72% / .42), hsl(220 90% 72% / .10) 45%, transparent 70%);animation:co-halo-b 21s var(--ease-in-out) infinite}
.co-bd__halo.c{left:26%;top:14%;width:50%;height:60%;background:radial-gradient(circle at center, hsl(0 0% 100% / .28), transparent 66%);animation:co-halo-c 18s var(--ease-in-out) infinite}
