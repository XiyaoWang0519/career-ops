...
## [1.26.0](https://github.com/XiyaoWang0519/career-ops/compare/career-ops-v1.25.0...career-ops-v1.26.0) (2026-08-12)


### Features

* **cover:** optional letter.signature sign-off block ([#2513](https://github.com/XiyaoWang0519/career-ops/issues/2513)) ([449c1df](https://github.com/XiyaoWang0519/career-ops/commit/449c1df4a235205bb1907c7c572d2fa09a9321b9)), closes [#2510](https://github.com/XiyaoWang0519/career-ops/issues/2510)
* **cv:** strip the Core Competencies section when it has no entries ([#2512](https://github.com/XiyaoWang0519/career-ops/issues/2512)) ([f1b2bc6](https://github.com/XiyaoWang0519/career-ops/commit/f1b2bc6eb7f553c60d60d43b672c7004a4a6b0ef)), closes [#2509](https://github.com/XiyaoWang0519/career-ops/issues/2509)
* **doctor:** warn when an API key is overriding the Claude subscription ([ccb7b0d](https://github.com/XiyaoWang0519/career-ops/commit/ccb7b0d86a8de28c5858c9276529b56a448cf7b7))
* **providers:** add remotli — Swiss remote job board ([#2464](https://github.com/XiyaoWang0519/career-ops/issues/2464)) ([dca9418](https://github.com/XiyaoWang0519/career-ops/commit/dca94180f9666dfc93b8dff4ff41bad97e58588d))
* **scan:** add getro, consider and joinup zero-auth providers ([#825](https://github.com/XiyaoWang0519/career-ops/issues/825)) ([c0a259a](https://github.com/XiyaoWang0519/career-ops/commit/c0a259a900eab439d95d9787eb093b445425d6bb))
* **scan:** make the pipeline and scan-history paths env-overridable ([#2568](https://github.com/XiyaoWang0519/career-ops/issues/2568)) ([402e798](https://github.com/XiyaoWang0519/career-ops/commit/402e7988d33962ae3e9eb7f76afa2e55ddc37f1c)), closes [#2271](https://github.com/XiyaoWang0519/career-ops/issues/2271)
...
* **a16z-speedrun:** retry a transient page failure instead of aborting the whole board ([#2506](https://github.com/XiyaoWang0519/career-ops/issues/2506)) ([50ce177](https://github.com/XiyaoWang0519/career-ops/commit/50ce17718c3ca5fc36103d41b48b30027eac44d8))
* **arbeitsagentur:** move to the v6 Jobsuche API ([#2494](https://github.com/XiyaoWang0519/career-ops/issues/2494)) ([a713ed5](https://github.com/XiyaoWang0519/career-ops/commit/a713ed5de2850d6e3f5acb5677f198a31483271a))
* **cover:** fail on an unresolved template token instead of shipping it into the letter ([#2586](https://github.com/XiyaoWang0519/career-ops/issues/2586)) ([3733414](https://github.com/XiyaoWang0519/career-ops/commit/3733414d6440c3f9c6834c4c2ac73245ef25d778))
* **cv:** pair _EMPTY fallbacks with their block so mixed rows stay aligned ([#2486](https://github.com/XiyaoWang0519/career-ops/issues/2486)) ([57af06b](https://github.com/XiyaoWang0519/career-ops/commit/57af06ba78515eb22c835adfef65ce5b45cc94eb))
* **cv:** pass a replacer function so $-patterns in candidate text stay literal ([#2588](https://github.com/XiyaoWang0519/career-ops/issues/2588)) ([097dac0](https://github.com/XiyaoWang0519/career-ops/commit/097dac0c8b811e2145449b6392e56b5d3f2a7fa5))
* **dedup:** use the shared Unicode-aware company key instead of a local ASCII copy ([#2587](https://github.com/XiyaoWang0519/career-ops/issues/2587)) ([130e3fa](https://github.com/XiyaoWang0519/career-ops/commit/130e3fa073e37655178566312ea741bfba24866c))
* **dedup:** write the blind-via key prefix as an escape, not a raw NUL byte ([1b57bb6](https://github.com/XiyaoWang0519/career-ops/commit/1b57bb65f30a1614dbd55e6dd6729357a767b7a7))
* **doctor:** treat the cloud billing switches as opt-in, not merely present ([#2593](https://github.com/XiyaoWang0519/career-ops/issues/2593)) ([acbd060](https://github.com/XiyaoWang0519/career-ops/commit/acbd06061d1ef90eef09a3a81cd4e3d6b7467247)), closes [#2592](https://github.com/XiyaoWang0519/career-ops/issues/2592)
* extend the backup-file ignore to .npmignore and pin it with a test ([#2560](https://github.com/XiyaoWang0519/career-ops/issues/2560)) ([f0e7a5d](https://github.com/XiyaoWang0519/career-ops/commit/f0e7a5db4fd0b0952492723227f62fb51741cbd6))
* **invite-match:** non-Latin company names returned zero candidates ([#2517](https://github.com/XiyaoWang0519/career-ops/issues/2517)) ([df43774](https://github.com/XiyaoWang0519/career-ops/commit/df43774c4df0c24acd48791ea513e41598af3757))
* **jd-skill-gap:** CRLF-terminated JDs extracted zero skills ([fa16f09](https://github.com/XiyaoWang0519/career-ops/commit/fa16f095f02605009e7bd603bba94149b99fef96))
* **merge-tracker:** write a lower-scored re-evaluation through instead of discarding it ([9036809](https://github.com/XiyaoWang0519/career-ops/commit/90368097c57f9f6ad5ee60efa67415f19d1e54db))
* **providers:** hackernews thread lookup filters by the whoishiring tag ([3aa5e15](https://github.com/XiyaoWang0519/career-ops/commit/3aa5e159d7c135c7e40f4677475f4b6cbc8583bd))
* **providers:** move The Hub to the v2 jobsandfeatured API ([6b33fc4](https://github.com/XiyaoWang0519/career-ops/commit/6b33fc45f3d4abe15be300fd0b3c9cf4999c57ff))
* **providers:** resize a16z page budgets for the 50-job page size ([36d0c44](https://github.com/XiyaoWang0519/career-ops/commit/36d0c444534f518fc127d70b81590aa1d2a3bf1a))
* **repo:** add .gitattributes so Windows checkouts stop producing whole-file diffs ([80d104f](https://github.com/XiyaoWang0519/career-ops/commit/80d104f994ba1e64a09b7a92a0d86641308cf64a))
* **scan:** read --company/--posted-after/--posted-before in =value form too ([#2589](https://github.com/XiyaoWang0519/career-ops/issues/2589)) ([b629ca0](https://github.com/XiyaoWang0519/career-ops/commit/b629ca09ae9cd4ea7e0ba871513229fee3bb7545))
* **seeds:** walk every YC page instead of stopping after page 1 ([#2526](https://github.com/XiyaoWang0519/career-ops/issues/2526)) ([6cf9e41](https://github.com/XiyaoWang0519/career-ops/commit/6cf9e41952dbe41e4fbe4751558d3107cf3a6924)), closes [#2525](https://github.com/XiyaoWang0519/career-ops/issues/2525)
* **update-system:** apply .gitattributes before the files it governs ([b630da2](https://github.com/XiyaoWang0519/career-ops/commit/b630da27e682d326f6ec809c71e0928a8f469680))
